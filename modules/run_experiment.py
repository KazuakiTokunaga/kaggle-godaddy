...
def main(BASE, external, params, use_umap=False, add_location=True):
    mbd = 'microbusiness_density'

    df_train, df_test, df_subm = utils.load_dataset(BASE)
    df_all, df_census = utils.merge_dataset(df_train, df_test, BASE=external, unemploy=False, census=True, fix_pop=True, coord=True, add_location=add_location, use_umap=use_umap, outlier=True)
